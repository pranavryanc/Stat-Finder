...
export const exploreSearches: ExploreSearch[] = [
  ...
  { id:'nfl-500-pass', title:'500+ Passing Yard Games', description:'The biggest single-game passing outputs in the standardized nflverse era.', category:'Passing', sport:'NFL', searchType:'Player', conditions:[{statistic:'passingYards',operator:'gte',value:500}] },
